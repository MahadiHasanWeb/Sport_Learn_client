...
const Footer = () => {
    ...
    return (
        <div>
            <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" className=" mx-auto">
                ...
                <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                                ...
                                <ul>
                                    <li className="mb-4">
                                        <a href="#" target="_blank"
                                            className="text-gray-600 hover:underline dark:text-gray-400">Sport Learn</a>
                                    </li>
                                    <li>
                    ...
                    <div  className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-lg text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">Sport Learn™</a>. All Rights Reserved.
                        </span>
